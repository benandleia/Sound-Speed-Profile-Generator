...
def filter_logs(ASDL_file):   
    ...
    for index, item in enumerate(logs):
        ...
        if match:
            ...
            timeval.append(readin[0])
            depthval.append(readin[6])
            soundval.append(readin[8])
...
#1000 readings, which is the most that TrackMan can handle. If there is, it slice the data frame to ensure that
